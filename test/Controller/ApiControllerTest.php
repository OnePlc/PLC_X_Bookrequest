...
use OnePlace\Bookrequest\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCannotBeAccessedWithoutKey() {
        $this->dispatch('/bookrequest/api', 'GET');
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/bookrequest/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('bookrequest-api');
    }
}
