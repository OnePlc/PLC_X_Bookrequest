<?php
/**
 * BookrequestControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Bookrequest Module
 *
 * @category Test
 * @package Bookrequest
...
namespace OnePlaceTest\Bookrequest\Controller;

use OnePlace\Bookrequest\Controller\BookrequestController;
...
class BookrequestControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/bookrequest', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('bookrequest');
        $this->assertControllerName(BookrequestController::class); // as specified in router's controller name alias
        $this->assertControllerClass('BookrequestController');
        $this->assertMatchedRouteName('bookrequest');
    }
    ...
    public function testAddActionCanBeAccessed() {
        ...
        $this->dispatch('/bookrequest/add', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('bookrequest');
        $this->assertControllerName(BookrequestController::class); // as specified in router's controller name alias
        $this->assertControllerClass('BookrequestController');
    ...
    public function testEditActionCanBeAccessed() {
        ...
        $this->dispatch('/bookrequest/edit/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('bookrequest');
        $this->assertControllerName(BookrequestController::class); // as specified in router's controller name alias
        $this->assertControllerClass('BookrequestController');
    ...
    public function testViewActionCanBeAccessed() {
        ...
        $this->dispatch('/bookrequest/view/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('bookrequest');
        $this->assertControllerName(BookrequestController::class); // as specified in router's controller name alias
        $this->assertControllerClass('BookrequestController');
